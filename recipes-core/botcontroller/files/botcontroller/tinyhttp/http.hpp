...
class HttpRequest : public HttpMessageCommon {
    ...
    public:
        ...
        #ifdef TINYHTTP_JSON
        const nlohmann::json& json() const noexcept { return mContentJson; }
        #endif
};
...
class HttpResponse : public HttpMessageCommon {
    ...
    public:
        ...
        #ifdef TINYHTTP_JSON
        HttpResponse(const unsigned statusCode, const nlohmann::json& json)
            : HttpResponse{statusCode, "application/json", json.dump()} {}
        #endif
